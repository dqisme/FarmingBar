...
L["Are you sure you want to delete the template \"%s\"?"] = true
...
L["Import"] = true
L["Include"] = true
L["Include All Factions"] = true
L["Include Alts"] = true
L["Include Auctions"] = true
L["Include Bank"] = true
L["Include counts from all factions for this tracker."] = true
...
L["Right-click to edit this objective."] = true
L["Limit Mats"] = true
...
L["Quest Failed"] = true
L["Quest Objective Complete"] = true
...
L["Set the sound played when a tracker's goal is complete."] = true
...
L["Set the sound played when progress is made towards a tracker."] = true
